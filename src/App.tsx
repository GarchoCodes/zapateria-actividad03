...
import { ZapatillasProvider } from './components/context/ZapatillasContext'
import DetallesZapatilla from './components/zapatillas/DetallesZapatilla'
import { CarritoProvider } from './components/context/CarritoContext'
import './index.css';
import DarkModeToggle from './components/common/DarkModeToggle'
import IconoCesta from './components/common/IconoCesta'
...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <ZapatillasProvider>
        <CarritoProvider>
          <nav className='flex items-center justify-between py-8 px-16 bg-gradient-to-b from-[oklch(0.96_0.04_262)] dark:from-[oklch(0.15_0.04_262)] from-85% to-transparent'>
            <div className='flex items-center'>
              <Link to={"/"}><svg fill="currentColor" className="size-20 text-[oklch(0.15_0.08_262)] dark:text-[oklch(0.96_0.08_262)]" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
		...
		c-7.351,0-21.378,0.336-27.117,0.336c-3.244,0-0.36-3.489-0.363-3.487L203.778,185.178z"/>
              ...
              <Link to={"/"} className='ml-32 text-lg text-[oklch(0.15_0.08_262)] dark:text-[oklch(0.96_0.08_262)]'>Inicio</Link>
              <Link to={"/productos"} className='ml-32 text-lg text-[oklch(0.15_0.08_262)] dark:text-[oklch(0.96_0.08_262)]'>Catálogo</Link>
            </div>
            <div className='flex items-center justify-center gap-8'>
              <DarkModeToggle />
              <Link to={"/carrito"}> <IconoCesta /> </Link>
            </div>
          </nav>
          ...
          <div className="flex-1">
            <Routes>
              ...
              <Route path='/producto/:id' element={<DetallesZapatilla />} />
              <Route path='/carrito' element={<Carrito />} />
            </Routes>
          </div>

          <footer className='flex items-center justify-center gap-16 py-8 px-4 bg-gradient-to-t from-[oklch(0.96_0.04_262)] dark:from-[oklch(0.15_0.04_262)] from-85% to-transparent'>
            <svg fill="currentColor" className="size-16 text-[oklch(0.15_0.08_262)] dark:text-[oklch(0.96_0.08_262)]" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 454.258 454.258">
              <g>
                <path d="M450.003,285.589l-2.341-3.443l-1.938,3.685c-12.648,24.029-54.696,38.389-88.041,38.389
		c-42.46,0-252.092-6.381-279.383-7.935c-5.395-0.32-11.03-0.469-17.735-0.469c-4.159,0-8.021,0.052-11.756,0.101
		...
		c-7.351,0-21.378,0.336-27.117,0.336c-3.244,0-0.36-3.489-0.363-3.487L203.778,185.178z"/>
            ...
            <p className='mt-4 text-[oklch(0.4_0.08_262)] dark:text-[oklch(0.76_0.08_262)]'>&copy; 2024 Zapatería Deportiva. Todos los derechos reservados.</p>
          </footer>
        </CarritoProvider>
      </ZapatillasProvider>
    </div>
